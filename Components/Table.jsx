const Table = ({ setCreateShipmentModel, allShipmentsData }) => {
  // -- timeStamp data from the Contract will converted to readable data, using following function
  ...
  // console.log("All Shipment Data: ", allShipmentsData);
      ...
      <div className="items-start justify-between md:flex">
        <div className="max-w-lg">
          ...
          <p className="text-gray-600 mt-2">
            ...
            distinctio quasi perferendis ea? Possimus dolor sit soluta corrupti,
            itaque doloribus officiis placeat.
          </p>
        </div>
      ...
      <div className="mt-12 shadow-sm border rounded-lg overflow-x-auto">
        <table className="w-full table-auto text-sm text-left">
          ...
          <tbody className="text-gray-600 divide-y">
            {/* Sometimes data fetched late, so question mark help us not to show error/undefined */}
